 ...
 * If you want to use routes.pux.mux.php for speed, you must set ORE_USE_MUX 
 * environment variable. See public/.htaccess.
 * And you must update config/routes.pux.mux.php manually, if you change this 
 * file. You can do it with update-mux.sh.
 * 
